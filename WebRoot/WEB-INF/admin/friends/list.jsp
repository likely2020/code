...
<div class="info-list">
	    ...
	    <tbody>
	    	<s:iterator value="recordList">
	    		<tr>
	    			...
	    			<td>${url}</td>
	    			<td>${position}</td>
	    			<td class="operate"><s:a action="friends_editUI?id=%{id}"><i class="fa fa-edit"></i>编辑</s:a><s:a action="friends_delete?id=%{id}" onClick="return isSure(this,'确定要删除吗？')"><i class="fa fa-remove"></i>删除</s:a></td>
	    		</tr>
	    	</s:iterator>
	    </tbody>
	  </table>
    ...
    <div class="grid-toolbar">
        <s:a action="friends_addUI">添加</s:a>
    </div>
</div>
